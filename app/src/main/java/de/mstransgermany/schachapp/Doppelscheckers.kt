...
import kotlinx.android.synthetic.main.activity_doppelscheckers.button_reset
import kotlinx.android.synthetic.main.activity_doppelscheckers.feld_1
import kotlinx.android.synthetic.main.activity_doppelscheckers.feld_2

import kotlin.random.Random

class Doppelscheckers : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_doppelscheckers)
    ...
    private fun feld1change() {
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            schwarz_oben.visibility = View.VISIBLE
